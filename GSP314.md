...
You may include additional info such as instructions or suggestions for solving the problem in the Documentation text area to send out along with the alert. This is optional but highly recommended for use in our real implementations.
